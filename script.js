function threeD(renderer, subscriber) {
  ...
  if (!renderer || !renderer.getContext) throw "renderer is nil";
  ...
  function render(start, end) {
    start = start
      .scale(30)
      .translate(new Vector(renderer.width / 2, renderer.height / 2));
    end = end
      .scale(30)
      .translate(new Vector(renderer.width / 2, renderer.height / 2));
    ctx.beginPath();
...
var runner = new threeD(document.getElementById("renderer"), console.log).run(
  Infinity
);
